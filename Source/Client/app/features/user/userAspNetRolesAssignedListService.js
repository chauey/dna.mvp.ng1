...
(function () {
    ...
    var controllerId = 'userAspNetRolesAssignedListService';

    // 1. Add controller to module
    angular
		.module('app.features')
		.service(controllerId, userAspNetRolesAssignedListService);

    // 2. Inject dependencies
    userAspNetRolesAssignedListService.$inject = ['$location', 'common', 'config', 'datacontext'];

    // 3. Define controller
    function userAspNetRolesAssignedListService($location, common, config, datacontext) {
        var that = this;
