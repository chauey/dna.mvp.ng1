...
var TableAdvanced = function () {
    ...
    var initTable = function (dataTableType) {
        var table = $('.' + dataTableType);
        ...
        //var tableWrapper = $('#DataTables_Table_0_wrapper'); // datatable creates the table wrapper by adding with id {your_table_jd}_wrapper
        //tableWrapper.find('.dataTables_length select').select2(); // initialize select2 dropdown
    }
    ...
    return {
        ...
        initServer: function () {
            ...
            initTable('data-table-server');

            console.log('Init datatable Server');
        }
    };
