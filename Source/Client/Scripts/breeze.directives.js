        ...
        function link(scope, element, attrs) {
            ...
            function linkForInput() {
                ...
                function valErrsChanged(newValue) {
                    ...
                    // DNA: Create custom id for error message div
                    var errorMessageId = 'id="errorMessageFor' + domEl.id + '"'
                    errorHtml = errorHtml.replace('class="invalid"', 'class="invalid" ' + errorMessageId);
